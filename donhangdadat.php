	...
	<div class="wrapper">
        ...
        <!-- form giỏ hàng -->
			...
			<tr style="border: 1px solid black; border-collapse: collapse;">
				...
				<td>
					<a style="text-decoration: none; list-style: none; font-family: Arial, Helvetica, sans-serif;  color: black;" href="themgiohang.php?cong=<?php echo $cart_item['id'] ?>">Cộng</a>
			...
			<tr>
				<td colspan="8">
					...
					<p style="float: right;"><a style="text-decoration: none; list-style: none; font-family: Arial, Helvetica, sans-serif;  color: black;" href="themgiohang.php?xoatatca=1">Xóa Tất Cả</a></p>
